 ...
 *
 * *** LOCAL CUSTOMIZATIONS in configure() function *** 
 *
 ...
 */
 metadata {
	definition (name: "Fibaro Motion Sensor (modified)", namespace: "smartthings", author: "SmartThings") {
...
def configure() {
    ...
    // 64: Temperature Reports Interval (0-65535, default 0)
	//cmds << zwave.configurationV1.configurationSet(configurationValue: [0, 60], parameterNumber: 64, size: 2).format()
    
    // 65: Temperature Offset (0-65535, default 0)
	//cmds << zwave.configurationV1.configurationSet(configurationValue: [0, 0], parameterNumber: 65, size: 2).format()
    
    // 80: LED Signaling Mode
	cmds << zwave.configurationV1.configurationSet(configurationValue: [14], parameterNumber: 80, size: 1).format() // green
    //cmds << zwave.configurationV1.configurationSet(configurationValue: [17], parameterNumber: 80, size: 1).format() // cyan

    // 81: LED Brightness (0-100, default 50)
	cmds << zwave.configurationV1.configurationSet(configurationValue: [1], parameterNumber: 81, size: 1).format()
